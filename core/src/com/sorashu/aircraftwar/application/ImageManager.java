...
public class ImageManager {
    ...
    public static Texture BACKGROUND_IMAGE = new Texture("img/bg1.jpg");
    public static Texture HERO_IMAGE = new Texture("img/hero.png");
    public static Texture HERO_BULLET_IMAGE = new Texture("img/bullet_hero.png");
    public static Texture ENEMY_BULLET_IMAGE = new Texture("img/bullet_enemy.png");
    public static Texture MOB_ENEMY_IMAGE = new Texture("img/mob.png");
    public static Texture ELITE_ENEMY_IMAGE = new Texture("img/elite.png");
    public static Texture BOSS_ENEMY_IMAGE = new Texture("img/boss.png");
    public static Texture BLOOD_PROP_IMAGE = new Texture("img/prop_blood.png");
    public static Texture BOMB_PROP_IMAGE = new Texture("img/prop_bomb.png");
    public static Texture BULLET_PROP_IMAGE = new Texture("img/prop_bullet.png");
